...
astraSmoothScroll = function(e, t) {
    ...
    function() {
        ...
        if (document.querySelectorAll(".search-field").forEach(e => {
            ...
            var E = document.querySelectorAll('a[href*="#"]:not([href="#"]):not([href="#0"]):not([href*="uagb-tab"]):not(.uagb-toc-link__trigger):not(.skip-link):not(.comment-reply-link):not(#cancel-comment-reply-link):not(.nav-links a):not([href*="tab-"])');
            if (E)
